...
<body>
  <div class="container">
    <div class="card">
        ...
        <div class="card inner">
          <div class="meta">
            ...
            <div class="field">
              ...
              <input id="preparedBy" type="text" placeholder="Name" />
            </div>
            <div class="field">
              <label>Checked By</label>
              <input id="checkedBy" type="text" placeholder="Name" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="footer">
        <div>
          <label class="small">General Remarks</label><br/>
          <textarea id="generalRemarks" rows="3"></textarea>
        </div>
        <div class="signatures">
          <div class="small">Prepared By</div><div class="line"></div>
          <div class="small">Checked By</div><div class="line"></div>
          <div class="small">Approved By</div><div class="line"></div>
        </div>
      </div>
  ...
  <script>
    ...
    function exportCSV() {
      const rows = [["Item Code","Description","UOM","Qty Ordered","Qty Received","Qty Accepted","Qty Rejected","Unit Price","Total Price","Remarks"]];
    ...
    function loadSample(){
      tbody.innerHTML="";
      addRow({code:"1001",desc:"Nestlé Milk Powder 1kg",uom:"pcs",ordered:50,received:50,accepted:48,rejected:2,price:5.50,remarks:"2 damaged"});
      addRow({code:"2005",desc:"Sunlight Soap 100g",uom:"pcs",ordered:100,received:100,accepted:100,rejected:0,price:0.80});
