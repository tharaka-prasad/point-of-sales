...
@section('title') <h3 class="mb-0">{{ $menu }}</h3>
@endsection
            ...
            <div class="grid">
                <div class="card inner">
                    <div class="meta">
                        <div class="field">
                            <label>Date</label>
                            <input id="poDate" type="date" name="date" value="{{ $po->date }}" required />
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            <label>PO No</label>
                            <input id="poNo" type="text" name="po_number" value="{{ $po->po_number }}" readonly />
                        </div>
                    </div>
                </div>
            ...
            <div class="table-wrap">
                <table id="itemsTable">
                    ...
                    <tbody id="tbody">
                        ...
                        <tr>
                            <td><input name="items[{{ $index }}][item_name]" value="{{ $item->item_name }}"></td>
                            <td><input name="items[{{ $index }}][category]" value="{{ $item->category }}"></td>
                            <td><input name="items[{{ $index }}][uom]" value="{{ $item->uom }}"></td>
                            <td><input name="items[{{ $index }}][qty]" class="qty" type="number" value="{{ $item->qty }}"></td>
                            <td><input name="items[{{ $index }}][rate]" class="rate" type="number" value="{{ $item->rate }}"></td>
                            <td class="total">{{ number_format($item->qty * $item->rate, 2) }}</td>
                            <td><input name="items[{{ $index }}][remarks]" value="{{ $item->remarks }}"></td>
